...
from mini_imagenet_mul3_rgbmo import MiniImageNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', default='/home/shenyq/zsl/prototypical-network-pytorch/exp/mean_rgb_rgbmo_task1/save/max-acc.pth')
